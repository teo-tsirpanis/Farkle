...
* Diagnostic messages are localizable, with English and Greek translations being provided.
...
* Farkle's string regexes got many improvements and bug fixes, bringing their syntax closer -but not a 100% match- to popular regex languages.
