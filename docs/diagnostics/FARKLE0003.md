# FARKLE0003: Symbol cannot be matched by any string

This warning is emitted when the builder detects that the regex of a symbol cannot be matched by any string.
