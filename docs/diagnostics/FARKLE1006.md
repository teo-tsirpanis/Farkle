...
This error is emitted when you attempt to call a source-generated production factory method in an unsupported way. Examples of such invalid parameters include:
