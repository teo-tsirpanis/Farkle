# FARKLE1009: Cannot infer types of production builder factory arguments

This warning is emitted when the production builder factory source generator fails to infer the type of some of the arguments to a call to `Production.Build`.
