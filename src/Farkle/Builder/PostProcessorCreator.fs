...
let internal create<'T> dfDef =
    ...
    let fusers =
        ...
        for i = 0 to arr.Length - 1 do
            ...
            arr.[i] <- prod.Fuser
        arr
    // A dynamic post-processor generated by Reflection.Emit used to be here
    // but was summarily removed due to https://github.com/dotnet/runtime/issues/68791#issuecomment-1115433642.
