...
{
    public static ProductionBuilder Build(IGrammarSymbol member1) =>
        ProductionBuilderMarshal.Create<ProductionBuilder>([member1], []);

    public static ProductionBuilder Build(string member1) =>
        ProductionBuilderMarshal.Create<ProductionBuilder>([Terminal.Literal(member1)], []);

    public static ProductionBuilder<T1> Build<T1>(IGrammarSymbol<T1> member1) =>
        ProductionBuilderMarshal.Create<ProductionBuilder<T1>>([member1], [0]);

    public static ProductionBuilder<T1> Build<T1>(string member1, IGrammarSymbol<T1> member2, string member3) =>
        ProductionBuilderMarshal.Create<ProductionBuilder<T1>>([Terminal.Literal(member1), member2, Terminal.Literal(member3)], [1]);

    public static ProductionBuilder<T1, T2> Build<T1, T2>(IGrammarSymbol<T1> member1, IGrammarSymbol<T2> member2) =>
        ProductionBuilderMarshal.Create<ProductionBuilder<T1, T2>>([member1, member2], [0, 1]);

    public static ProductionBuilder<T1, T2> Build<T1, T2>(IGrammarSymbol<T1> member1, IGrammarSymbol member2, IGrammarSymbol<T2> member3) =>
