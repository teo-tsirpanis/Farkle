...
type RuntimeGrammar =
    abstract DFAStates: DFA
    abstract LALRStates: LALR
    abstract Groups: RandomAccessList<Group>
...
module RuntimeGrammar =
    ...
    let dfaStates (x: #RuntimeGrammar) = x.DFAStates
    ...
    let lalrStates (x: #RuntimeGrammar) = x.LALRStates