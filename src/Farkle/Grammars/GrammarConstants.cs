...
internal static class GrammarConstants
{
    ...
    public static ReadOnlySpan<byte> EgtHeader => "G\0O\0L\0D\0 \0P\0a\0r\0s\0e\0r\0 \0T\0a\0b\0l\0e\0s\0/\0v\05\0.\00\0\0\0"u8;
    ...
    public const int MinPaddingBytes = sizeof(ulong) - 1;

    public const string HeaderMagicString = "\u6146\u6b72\u656c";
    public const string CgtHeaderString = "GOLD Parser Tables/v1.0";
    public const string EgtHeaderString = "GOLD Parser Tables/v5.0";
